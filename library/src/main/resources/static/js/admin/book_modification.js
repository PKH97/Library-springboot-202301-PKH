...
class BookModificationService {
    ...
    setBookCode() {
        ...
        bookObj.bookCode = URLSearch.get("bookCode"); //-> 객체의 정보를 가져오는 방식
    }
    ...
    loadBookAndImageData() {
        ...
        if(responseData.bookImage != null) {
            ...
            const bookImg = document.querySelectorAll(".book-img");
